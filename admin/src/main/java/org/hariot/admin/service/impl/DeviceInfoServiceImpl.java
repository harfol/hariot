...
import org.hariot.admin.dao.mapper.DeviceInfoMapper;
import org.hariot.admin.service.DeviceInfoService;
import org.hariot.admin.service.constant.DeviceStatusCode;
...
public class DeviceInfoServiceImpl implements DeviceInfoService {
    ...
    @Override
    public Boolean updateAlarmStatus(String deviceName,Float currentTemperatureValue, boolean b) {
        DeviceInfo deviceInfo=new DeviceInfo();
        deviceInfo.setAlarmStatus(b);
        deviceInfo.setGmtUpdate(new Date());
        if(currentTemperatureValue!=null){
            deviceInfo.setCurrentTemperature(currentTemperatureValue);
        }
        if(b){
