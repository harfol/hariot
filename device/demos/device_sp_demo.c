...
int main(int argc, char *argv[])
{
    ...
    {
        //char *sub_topic = "/a1vZTRTxXyE/test_device01/user/test";
    ...
    if( strcmp("pub", action) >= 0 ){
        // char *pub_topic = "/a1vZTRTxXyE/test_device02/user/test";	
        //char *pub_topic = "/sys/a13FN5TplKq/mqtt_basic_demo/thing/event/property/post";
    	//char *pub_topic = "/sys/a1vZTRTxXyE/test_device02/thing/event/property/post";   
